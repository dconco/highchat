<?php 
    ...
    if (isset($_COOKIE["user_id"])) {
        ...
        header("location: /login.php?next=/users/following.php");
    ...
    $sql = "SELECT * FROM follow WHERE follow_by = {$user_id} AND (follow 
...
<html lang="en">
<head>
    <title>YOUR FOLLOWINGS | HIGHCHAT</title>
        ...
        <div class="navbar bg-secondary fixed-top" data-aos="fade-down">
            <div class="container-fluid">
                <div class="navbar-brand" data-aos="zoom-out" data-aos-delay="700">
                    ...
                    <span class="text-light logo-text">HighChat - Followings</span>
                </div>
            </div>
          
            <!-- SEARCH FIELDS -->
            <div class="container search-wrapper input-group" data-aos="slide-left" data-aos-delay="1000">
                <input type="search" id="searchUser" class="form-control" placeholder="Search your Followings...">
    ...
    <main class="container d-flex flex-column">
        ...
        <div class="text-center links d-flex m-auto">
            ...
            <a href="/users/following.php">
                <div class="p-1 card text-secondary active" style="padding:10px 20px 10px 20px !important;font-size:17px">Following</div>
            </a>
        </div>
        <hr />
        ...
        <?php 
            if ($result->num_rows > 0) {
                include_once("configs/following.php");
                echo $output;
            } else {
                echo "<h3 class='text-center' style='font-size:20px'>You're not Following any user!</h3>";
            }
        ?>
    </main>
