<?php 
    ...
    if (isset($_COOKIE["user_id"])) {
        ...
        header("location: /login.php?next=/users/friends.php");
    ...
    $sql = "SELECT user_id, friend_id FROM friends WHERE user_id = {$user_id} OR friend_id = {$user_id} ORDER BY id DESC";
...
<html lang="en">
<head>
    <title>YOUR FRIENDS | HIGHCHAT</title>
        ...
        <div class="navbar bg-secondary fixed-top" data-aos="fade-down">
            <div class="container-fluid">
                <div class="navbar-brand" data-aos="zoom-out" data-aos-delay="700">
                    ...
                    <span class="text-light logo-text">HighChat - Friends</span>
                </div>
            </div>
          
            <!-- SEARCH FIELDS -->
            <div class="container search-wrapper input-group" data-aos="slide-left" data-aos-delay="1000">
                <input type="search" id="searchUser" class="form-control" placeholder="Search your Friends...">
    ...
    <main class="container d-flex flex-column">
        ...
        <div class="text-center links d-flex m-auto">
            ...
            <a href="/users/friends.php">
                <div class="p-1 card text-secondary active" style="padding:10px 20px 10px 20px !important;font-size:17px">Friends</div>
            </a>
            
            <!-- FOLLOWERS -->
            <a href="/users/followers.php">
                <div class="p-1 card text-secondary bg-transparent" style="padding:10px 20px 10px 20px !important;font-size:17px">Followers</div>
            </a>
        ...
        <?php 
            if ($result->num_rows > 0) {
                include_once("configs/friends.php");
                echo $output;
            } else {
                echo "<h3 class='text-center' style='font-size:20px'>You don't have any Friends yet!</h3>";
            }
        ?>
    </main>
