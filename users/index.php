<?php 
    ...
    if (isset($_COOKIE["user_id"])) {
        ...
        header("location: /login.php?next=/users/");
...
<html lang="en">
<head>
    <title>DISCOVER USERS | HIGHCHAT</title>
...
<body>
        ...
        <div class="navbar bg-secondary fixed-top" data-aos="fade-down">
            <div class="container-fluid">
                <div class="navbar-brand" data-aos="zoom-out" data-aos-delay="700">
                    ...
                    <span class="text-light logo-text">HighChat - All Users</span>
                </div>
            </div>
          
            <!-- SEARCH FIELDS -->
            <div class="container search-wrapper input-group" data-aos="slide-left" data-aos-delay="1000">
                <input type="search" id="searchUser" class="form-control" placeholder="Search for all users...">
    ...
    <main class="container d-flex flex-column">
        ...
        <?php 
            if ($result->num_rows > 0) {
                include_once("configs/all_users.php");
                echo $output;
            } else {
                echo "<h3 class='text-center' style='font-size:20px'>There's no User on this Server!</h3>";
            }
        ?>
    </main>
    ...
    <footer class="container d-flex flex-row m-auto">
        ...
        <a href="/users/"><i class="bi bi-person-plus-fill text-success"></i></a>
